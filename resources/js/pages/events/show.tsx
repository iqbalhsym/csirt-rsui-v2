...
export default function EventShow({ event }: EventShowProps) {
    ...
    return (
        <div className={`min-h-screen font-sans transition-colors duration-300 relative overflow-x-hidden ${isDarkMode ? 'bg-slate-950 text-slate-100' : 'bg-slate-50 text-slate-900'}`}>
            <Head title={`${event.title} | Event CSIRT RSUI`}>
            ...
            <main className="max-w-4xl mx-auto px-6 py-12 relative z-10 w-full space-y-8">
                ...
                <div className={`grid sm:grid-cols-2 gap-4 p-5 rounded-2xl border ${
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="text-[11px] leading-tight">
                            <span className="block text-slate-500 font-bold uppercase tracking-wider">Tanggal & Waktu</span>
                    ...
                    {event.location && (
                        <div className="flex items-center gap-3">
                            ...
                            <div className="text-[11px] leading-tight">
                                <span className="block text-slate-500 font-bold uppercase tracking-wider">Lokasi / Platform</span>
                ...
                <div className="flex flex-wrap justify-between items-center text-xs text-slate-500 border-t pt-6 border-slate-900/30 gap-4">
                    ...
                    <Link 
                        href="/events" 
                        className="inline-flex items-center gap-1.5 font-bold text-teal-400 hover:text-teal-350 transition-colors"
                    >
                        <ArrowLeft className="w-4 h-4" /> Kembali ke semua agenda
                    </Link>
                </div>
            </main>
